...
public class GenerateBankReport extends HttpServlet  {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "select t.fare_collected from ticket t,toll_plaza p,pass_type pt,vehicle_type v where v.vehicle_type_id=t.vehicle_type_id and pt.pass_id=t.pass_type and p.toll_plaza_id=t.to_toll_plaza_id and date(t.registration_time) BETWEEN '"+fromDate+"' AND '"+toDate+"' and t.from_toll_plaza_id='"+tollid+"'";
